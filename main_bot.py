...
from db_main import save_info_db, intermediate_status
...
def handle_document(message: telebot.types.Message) -> None:
    """Конвертирует полученный .docx-файл в PDF."""
    try:
        ...
        intermediate_status(user_id, original_file_id, "pending")
        ...
        intermediate_status(user_id, original_file_id, "processing")
